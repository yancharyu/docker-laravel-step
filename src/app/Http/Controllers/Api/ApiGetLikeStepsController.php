...
class ApiGetLikeStepsController extends Controller
{
    /**
     * Handle the incoming request.
     *
     * @param  \Illuminate\Http\Request $request->fetchedIdList 既に取得済みのIDリスト
     * @return \Illuminate\Http\Response いいねしたステップを10件ずつ取得する
     */
    public function __invoke(Request $request): ?JsonResponse
    {
        ...
        $steps = $user->getLikeSteps()->with(['user', 'category'])->offset($offset)->limit($limit)->latest()->get();
